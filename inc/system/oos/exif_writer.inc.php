...
*	@package		util
*/
require_once(dirname(__FILE__)."/exif_reader.inc.php");

/**
*
*/
class exif_writer extends exif_reader {

    /**
    *  Constructor
    */
    function exif_writer($image) {
         $this->exif_reader($image);
         $this->processFile();
    }
