...
//		die(USR_LANG);
		...
		if(!is_file($file)){
			...
			if(is_file(CONF::inc_dir().'mods/'.$target_folder.'/language/'.CONF::project_name().'/'.CONF::default_lang().'.php'))
			{
				$file = CONF::inc_dir().'mods/'.$target_folder.'/language/'.CONF::project_name().'/'.CONF::default_lang().'.php';
			}
			else
			{
				$file = CONF::inc_dir().'mods/'.$target_folder.'/language/'.CONF::default_lang().'.php';
			}
			...
			if(!is_file($file))
			{
				...
				if(!is_file($file))
				{
					$file = CONF::inc_dir().'etc/lang/'.CONF::default_lang().'.php';
				}
			}
		}
