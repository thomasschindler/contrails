    ...
    function ProcessExifDir($DirStart, $OffsetBase, $ExifLength) {
        ...
        for ($de=0;$de<$NumDirEntries;$de++){
            ...
            */
			...
			//	commented out in sandbox due to numerous PHPLint issues
			/*
            ...
            switch($Tag){
                ...
                case TAG_FOCALPLANEUNITS:
                    switch($this->ConvertAnyFormat($ValuePtr, $Format)){
                        ...
                        case 5: $this->FocalplaneUnits = 0.001;	break;  // micrometer
                    }
