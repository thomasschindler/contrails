...
class CLIENT {
	...
	public function __construct($auth = false, $ignore_cookie = false, $quickreturn = false) 
	{
		...
		{
			die("a serious error occurred. we could not map you to a system user. [client:227]");		/* (TODO) better handling of this case */
		}
	...
	*/
	...
	public function &singleton($params = null, $ignore_cookie = false,$quickreturn = false) 
	{
		static $instance;	
		if (!is_object($instance)) 
		{
			$instance = new CLIENT($params,$ignore_cookie,$quickreturn);
		}
		return $instance;
	}
